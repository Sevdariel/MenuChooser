...
namespace MenuChooser.Repository
{
    public class UserService
    {
        ...
        public async Task UpdateAsync(int id, User updatedUser) => await _userCollection.ReplaceOneAsync(x => x.Id == id, updatedUser);

        public async Task RemoveAsync(int id) => await _userCollection.DeleteOneAsync(x => x.Id == id);
    }
}
